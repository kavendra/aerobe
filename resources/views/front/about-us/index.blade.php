...
@section('content')
  <div class="top-banner">
    <div class="imgb">
        @if ($aboutUs->header_image && file_exists(public_path('assets/uploads/about-page/' . $aboutUs->header_image)))
        <img src="{{ asset('assets/uploads/about-page/'.$aboutUs->header_image) }}" />
        @else
