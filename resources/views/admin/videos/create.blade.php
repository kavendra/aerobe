...
@endsection
    @section('content')
     <form method="post" class="needs-validation" novalidate action="{{ route('admin.video.store') }}" enctype="multipart/form-data">
    @csrf
    @method('post')
    <div class="row">
        <div class="col-lg-12">
                           ...
                           <div class="col-lg-6">
                                    ...
                                    <select id="product_id" class="form-select" name="product_id" required>
                                        ...
                                        @foreach($ourPortfolios as $ourPortfolio)
                                            <option value="{{ $ourPortfolio->id }}"
                                                {{ old('product_id') == $ourPortfolio->id ? 'selected' : '' }}>
                                                {{ $ourPortfolio->title }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input id="label" name="label" placeholder="Enter Title" type="text" class="form-control" value="{{ old('label') }}" required>
                            ...
                            <div class="col-lg-6">
                                <div class="mb-3">
                                    ...
                                    <input id="url" name="url" placeholder="Enter Title" type="text" class="form-control" value="{{ old('url') }}" required>
