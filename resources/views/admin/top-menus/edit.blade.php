                            ...
                            <div class="row col-lg-12">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input id="label" name="label" placeholder="Enter Name" type="text" class="form-control" value="{{$topMenu->label }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input id="link" name="link" placeholder="Enter Link" type="text" class="form-control" value="{{ $topMenu->link }}" required>
                                    </div>
                                </div>
