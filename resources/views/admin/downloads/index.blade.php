...
@endsection
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Download List <a href="{{ route('admin.download.create') }}" style="float:right"><button type="button" class="btn btn-outline-primary waves-effect waves-light" fdprocessedid="ub8ltb">Add New Download</button></a></h4>
                    </div>
                    <div class="card-body">
    ...
    @section('scripts')
        ...
        <script>
            ...
            function loadGrid() {
                fetch('{{ route('admin.download.index') }}', { // ✅ use indexdata route here
                     headers: { 
            ...
            function editRecord(id) {
                const editUrl = "{{ url('admin/download') }}/" + id + "/edit";
