...
@section('content')
    <form method="post" class="needs-validation" novalidate action="{{ route('admin.testimonial.update', $testimonial->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-lg-12">
                        ...
                        <div class="p-4">
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1 overflow-hidden">
                                    <h5 class="font-size-16 mb-1">Edit Testimonial Information  <a href="{{ route('admin.testimonial.index') }}" style="float:right"><button type="button" class="btn btn-outline-primary waves-effect waves-light" fdprocessedid="ub8ltb">Testimonial Listing</button></a></h5>
                            ...
                            <div class="row col-lg-12">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input id="label" name="label" placeholder="Enter Name" type="text" class="form-control" value="{{ $testimonial->label }}" required>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        @if ($testimonial->image && file_exists(public_path('assets/uploads/testimonials/' . $testimonial->image)))
                                            <img src="{{ asset('assets/uploads/testimonials/' . $testimonial->image) }}" class=" me-2" title="Logo" width="150" height="120" data-holder-rendered="true" />
                                        @else
                                            <img src="{{ asset('assets/images/no-image.png') }}" class=" me-2" title="Logo" width="150" height="120"data-holder-rendered="true" />
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 mb-3">
                                    ...
                                    <select id="input9" class="form-select" name="status">
                                        <option value="1" @if($testimonial->label == 1) selected @endif>Active</option>
                                        <option value="0" @if($testimonial->label == 0) selected @endif>Inactive</option>
                                    </select>
                                </div>
                            </div>
                        </div>
