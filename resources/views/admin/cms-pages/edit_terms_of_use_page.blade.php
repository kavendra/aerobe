...
@section('content')
    <form method="post" class="needs-validation" novalidate action="{{ route('admin.terms-of-use-page.update', $termsOfUsePage->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-lg-12">
                        ...
                        <div class="p-4">
                            <div class="d-flex align-items-center">
                                <div class="flex-grow-1 overflow-hidden">
                                    <h5 class="font-size-16 mb-1">Terms Of Use Page Information</h5>
                            ...
                            <div class="row col-lg-8">
                                ...
                                <div class="row col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea type="text" class="form-control" name="header_desc" placeholder="Enter Header Description" id="header_desc">{{ $termsOfUsePage->header_desc }}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="p-4 border-top">
                                ...
                                <div class="row col-sm-8">
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input id="meta_title" name="meta_title" placeholder="Enter Meta Title" type="text" class="form-control" value="{{ $termsOfUsePage->meta_title }}">
                                        </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input id="meta_keywords" name="meta_keywords" placeholder="Enter Meta Keywords" value="{{ $termsOfUsePage->meta_keywords }}" type="text" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row col-sm-8">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" id="meta_description" placeholder="Enter Meta Description" name="meta_description" rows="4">{{ $termsOfUsePage->meta_description }}</textarea>
                                    </div>
                                </div>
